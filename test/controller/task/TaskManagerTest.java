...
public abstract class TaskManagerTest {
    ...
    protected Epic epic;
    protected Task taskWithDateTime1;
    protected Task taskWithDateTime2;
    protected Task taskWithDateTime3;
    protected Subtask subtaskWithDateTime1;
    protected Subtask subtaskWithDateTime2;
    protected Subtask subtaskWithDateTime3;
    ...
    void updateTask() {
        ...
        Task updateTaskWithDateTime1 = new Task("task1", "test1", Status.IN_PROGRESS, taskWithDateTime1.getStartTime(),
                (int) Duration.between(taskWithDateTime1.getStartTime(), taskWithDateTime1.getEndTime()).toMinutes());
        updateTaskWithDateTime1.setId(taskWithDateTime1.getId());

        Task notUpdateTaskWithDateTime1 = new Task("task1", "test1", Status.IN_PROGRESS, taskWithDateTime2.getStartTime(),
                (int) Duration.between(taskWithDateTime1.getStartTime(), taskWithDateTime1.getEndTime()).toMinutes());
    ...
    void updateSubtask() {
        ...
        Subtask updateSubtaskWithDateTime1 = new Subtask("task1", "test1", Status.IN_PROGRESS,
                subtaskWithDateTime1.getStartTime(),
                (int) Duration.between(subtaskWithDateTime1.getStartTime(), subtaskWithDateTime1.getEndTime()).toMinutes(),
        ...
        Subtask notUpdateSubtaskWithDateTime1 = new Subtask("task1", "test1", Status.IN_PROGRESS,
                subtaskWithDateTime3.getStartTime(),
                (int) Duration.between(subtaskWithDateTime1.getStartTime(), subtaskWithDateTime1.getEndTime()).toMinutes(),
                subtaskWithDateTime1.getIdParentEpic());
